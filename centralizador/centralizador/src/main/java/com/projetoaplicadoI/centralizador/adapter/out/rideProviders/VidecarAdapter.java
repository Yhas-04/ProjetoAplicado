...
@Component
public class VidecarAdapter implements RideProviderPort {

    private final RestTemplate restTemplate;

    @Value("${app.providers.videcar.url:http://localhost:8086}")
    private String videcarUrl;

    public VidecarAdapter() {
