...
@RestController
public class Videcar {

    private static final Random random = new Random();
    private static final double BASE_PRICE = 18.00;
    private static final double PRICE_PER_KM = 1.80;
    private static final double AVERAGE_SPEED = 0.85;
